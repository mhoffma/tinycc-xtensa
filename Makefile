...
NATIVE_DEFINES_$(CONFIG_xtensa) += -DTCC_TARGET_XTENSA
NATIVE_DEFINES_$(CONFIG_javascript) += -DTCC_TARGET_JAVASCRIPT
...
TCC_X = i386 x86_64 i386-win32 x86_64-win32 x86_64-osx arm arm64 arm-wince c67 xtensa javascript
...
DEF-xtensa      = -DTCC_TARGET_XTENSA
DEF-javascript  = -DTCC_TARGET_JAVASCRIPT
...
xtensa_FILES = $(CORE_FILES) xtensa-gen.c xtensa-link.c
javascript_FILES = $(CORE_FILES) javascript-gen.c javascript-link.c
